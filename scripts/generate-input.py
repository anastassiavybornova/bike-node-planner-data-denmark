...
if geofa:
    ...
    # TODO add here a step where data is being fetched and clipped from `network-communication` 
    # NO raw data saved to `network/raw`; ONLY simplified data saved to `network/processed`
    pass
